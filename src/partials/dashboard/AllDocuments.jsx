...
import { InboxStackIcon } from '@heroicons/react/24/solid'; // <-- Add this
    ...
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-xs rounded-xl">
      <div className="px-5 pt-5">
        <header className="flex justify-between items-start mb-2">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2">Semua Dokumen</h2>
        ...
        <div className="flex items-center">
          <div className="text-5xl font-bold text-gray-800 dark:text-gray-100 mr-2">12345</div>
        </div>
