    ...
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white dark:bg-gray-800 shadow-xs rounded-xl">
      <div className="px-5 pt-5">
        <header className="flex justify-between items-start mb-2">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2">Surat Masuk</h2>
         
         {/* Mail icon */}
          <div className="p-2 bg-violet-100 dark:bg-violet-500/10 rounded-full">
            <InboxIcon className="w-5 h-5 text-violet-500 dark:text-violet-400" />
          </div>
        </header>
        <div className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase mb-1">Total</div>
        <div className="flex items-center">
          <div className="text-5xl font-bold text-gray-800 dark:text-gray-100 mr-2">131</div>
        </div>
