...
export default function AllDocumentsCard() {
  const { user } = useAuth();
    ...
    <>
      ...
      {editTarget && (
        <EditMailCard
          ...
          onUpdated={() => {
            setEditTarget(null);
            fetchDocuments(pagination.page); // Refresh list after update
          }}
        />
      )}
          ...
          <table className="min-w-full table-fixed dark:text-gray-300">
            <thead className="text-sm uppercase text-gray-400 dark:text-gray-500 bg-gray-50 dark:bg-gray-700/50">
              <tr>
                ...
                <th className="p-2 text-left font-semibold">Asal/Tujuan</th>
      ...
      {viewTarget && (
        <ViewMailCard
          ...
          type={viewTarget.type} // Make sure ViewMailCard expects 'type'
